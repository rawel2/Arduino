...
********************************************************/
  ...
  void ColorFill_noFlip(unsigned char R,unsigned char G,unsigned char B);
  void RectangleFill_noFlip(unsigned char x, unsigned char y,unsigned char x1, unsigned char y1,unsigned char R,unsigned char G,unsigned char B);
