...
void PrzesunLitereBG(char chr,unsigned char R,unsigned char G,unsigned char B,unsigned char Rbg,unsigned char Gbg,unsigned char Bbg)
{
 for(char j = -7;j < 7;j++)
  {
    DispShowCharBG(chr,R,G,B,j,Rbg,Gbg,Bbg);
    delay(100);
  } 
}

void PrzesunLitere(char chr,unsigned char R,unsigned char G,unsigned char B)
{
 for(char j = -7;j < 7;j++)
  {
    DispShowChar(chr,R,G,B,j);
    delay(100);
  } 
}
...
void loop()
{
  ...
  PrzesunLitereBG('a',  5,  0,  5,  80, 60,160);
  PrzesunLitereBG(' ',  5,  0,  5, 100, 50,150);
  PrzesunLitereBG('J',  5,  0,  5, 120, 40,140);
  PrzesunLitereBG('a',  5,  0,  5, 140, 30,130);
  PrzesunLitereBG('k',  5,  0,  5, 160, 20,120);
  PrzesunLitereBG('u',  5,  0,  5, 180, 10,110);
  PrzesunLitereBG('b',  5,  0,  5, 200, 00,100);
