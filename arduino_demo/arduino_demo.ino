...
//  if (y0 > 0) {y0=0;}
  ...
  //DispShowChar('K',  x0,  x0,  x0, y0, 3, paletteShift>1000,0);
  //DispShowChar('u',  x0,  x0,  x0, y0, 2, paletteShift>1000,0);
  //DispShowChar('b',  x0,  x0,  x0, y0, 1, paletteShift>1000,0);
  //DispShowChar('a',  x0,  x0,  x0, y0, 0, paletteShift>1000,0);
